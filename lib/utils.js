...
const { URL_MATCHER, TYPE_URL, TYPE_REGEX, TYPE_PATH, TYPE_REWRITE } = require('./matchers')
...
//   pattern: ({ url }) => urlEncodeRegexTag`(^${url.protocol}//${url.username}:.+@)?${url.hostname}`,
 ...
 *
 * @example
 * console.log("this will assume you are passing in a string that is a url, and will redact the password")
